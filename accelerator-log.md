...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [jenkins-test-app->jenkins-test-app]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=stuartblackburnvmware&repo=jenkins-test-app'
